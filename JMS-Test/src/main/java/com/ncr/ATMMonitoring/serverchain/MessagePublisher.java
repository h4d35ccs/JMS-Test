...
public interface MessagePublisher {
     ...
     * @param wrappedMessage MessageWrapper
     */
    ...
    /**
     * Instantiate a MessageWrapper with the given id and default message, adds the 
     * SpecificMessage into the wrapper and send it to the outgoing topic
     *  @param id wrapper id 
     *  @param wrappedMessage
     */
    ...
    /**
     * Instantiate a MessageWrapper with the given wrapper message and default id, adds the 
     * SpecificMessage into the wrapper and send it to the outgoing topic
     *  @param id wrapper id 
     *  @param wrappedMessage
     */
    public void publishOutgoingMessage(String wraperMessage,SpecificMessage wrappedMessage);
    /**
     * Instantiate a MessageWrapper with the given id and  message, adds the 
     * SpecificMessage into the wrapper and send it to the outgoing topic
     * @param id wrapper id 
     * @param wrapperMessage message to add in the wrapper 
     * @param wrappedMessage SpecificMessage
     */
    public void publishOutgoingMessage (int id,
	    String wrapperMessage, SpecificMessage wrappedMessage);
     ...
     * @param wrappedMessage
     */
    public void publishIncomingMessage(String wraperMessage,SpecificMessage wrappedMessage);
     ...
     * @param wrappedMessage SpecificMessage
     */
    public void publishIncomingMessage( int id,
	    String wrapperMessage,SpecificMessage wrappedMessage);
